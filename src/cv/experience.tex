  ...
  \cventry
    ...
    {Jan. 2022 - Present} % Date(s) — incorporated 18/01/2022, RCS Paris 909 764 615
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Founded Co.Factory, an advisory company providing strategy, technology, and information-systems consulting to early-stage founders and technology companies.}
        \item {Vehicle for angel investing activities; portfolio includes Pruna AI (AI model compression \& efficiency --- \$6.5M seed led by EQT Ventures, Nov. 2024).}
      \end{cvitems}
    }
