  ...
  \cventry
    ...
    {Jan. 2022 - Present} % Date(s) — incorporated 18/01/2022, RCS Paris 909 764 615
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Independent AI consultancy: fractional CTO for startups, advisor to investors, from strategy to production.}
        \item {Hands-on engagements: product \& platform strategy, architecture, generative-AI adoption, and technical due diligence.}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {May 2019 - July 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \end{cvsubitems}
        \item {Lessons learned: Amazon culture is a major asset for startups. Cloud adoption has a strong tendancy to accelerate startup growth.}
      \end{cvitems}
    }
