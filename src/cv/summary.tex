...
\begin{cventries}
    {
        ...
        \begin{chronology}[3]{2011}{2027}{0.85\textwidth}[\textwidth]
            ...
            \event{\decimaldate{1}{6}{2025}}{\descriptionstyle{15K+ Customers}} % TODO: confirm milestone date
            \event{\decimaldate{1}{6}{2026}}{\descriptionstyle{1,000+ Models}} % TODO: confirm milestone date
            \tikzset{chronevent/.style={fill=black,draw=none,opacity=0.5}}
